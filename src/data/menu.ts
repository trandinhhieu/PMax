...
export const menuItems = ([
  ...
  {
    id: "smoked-pork-and-parmigiano-pizza",
    category: "pizza",
    groupId: "pizza-classic",
  ...
  {
    id: "eggplant-and-blue-cheese-pizza",
    category: "pizza",
    groupId: "pizza-specialty",
  ...
  {
    id: "lemongrass-and-lemonade-fizz-soda",
    category: "drinks",
    groupId: "fizz-soda",
  ...
  {
    id: "tamarind-and-vanilla-fizz-soda",
    category: "drinks",
    groupId: "fizz-soda",
...
] satisfies MenuItem[]).sort((a, b) => a.displayOrder - b.displayOrder);
...
export function getMenuPreviewItems(category: MenuCategory) {
