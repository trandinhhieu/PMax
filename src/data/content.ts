...
export const copy = {
  en: {
    ...
    hero: {
      eyebrow: "Near My Khe Beach, Da Nang",
      title: "Wood-fired Pizza Near My Khe Beach",
      body: "Fresh dough, blistered crusts, cold drinks, and an easy open-air table after the beach.",
    ...
    form: {
      ...
      success: "WhatsApp is opening with your booking details. Please press Send there so Hermanos receives your request.",
  ...
  vi: {
    ...
    hero: {
      eyebrow: "Gần biển Mỹ Khê, Đà Nẵng",
      title: "Pizza nướng củi gần biển Mỹ Khê",
      body: "Đế bánh làm tươi, viền cháy xém thơm, đồ uống mát lạnh và bàn open-air dễ chịu sau khi đi biển.",
      directions: "Chỉ đường",
      menu: "Xem menu",
      booking: "Đặt bàn",
    },
    ...
    form: {
      ...
      success: "WhatsApp đang mở kèm thông tin đặt bàn. Vui lòng bấm Gửi trong WhatsApp để Hermanos nhận yêu cầu.",
